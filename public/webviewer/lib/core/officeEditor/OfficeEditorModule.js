  ...
  (function (e) {
    ...
    function (e, c, d) {
          ...
          return Object(g.a)(void 0, void 0, Promise, function () {
            ...
            return Object(g.b)(this, function (x) {
              switch (x.label) {
                ...
                case 2:
                  return (
                    (t = self.BrotliDecode(Object(a.b)(w))),
                    [2, v ? t : Object(a.a)(t)]
                  );
              }
            });
      ...
      (function () {
        ...
        w.prototype.End = function () {
          if (this.remainingDataArrays.length) {
            for (var v = this.arrays, t = 0, x = 0; x < v.length; ++x)
              t += v[x].length;
            t = new Uint8Array(t);
            var y = 0;
      ...
      var m = function (w) {
          ...
          t.open("GET", w.url, w.isAsync);
          var x = v && t.overrideMimeType;
          t.responseType = x ? "text" : "arraybuffer";
          x && t.overrideMimeType("text/plain; charset=x-user-defined");
          t.send();
          var y = function () {
            var C = Date.now();
            var z = x ? t.responseText : new Uint8Array(t.response);
        ...
        B = function (w, v, t, x) {
          a: {
            var y = [n];
            v = { compressedMaximum: v, isAsync: t, shouldOutputArray: x };
            if (v.isAsync) {
              var A = y[0](w, v);
              for (t = 1; t < y.length; ++t) A = r(A, w, v, y[t]);
            } else {
    ...
    function (e, c, d) {
      function g(f, h, l) {
        ...
        var q, m;
        return p(!!WebAssembly.instantiateStreaming).then(function (u) {
          Object(b.a)(
            "load",
    ...
    function (e, c, d) {
      function g(k, a, f, h) {
        ...
        return new (f || (f = Promise))(function (p, q) {
          ...
          function n(r) {
            r.done ? p(r.value) : l(r.value).then(m, u);
          }
    ...
    function (e, c, d) {
      ...
      var g = d(2),
        ...
        f = function (h, l, p) {
          if (Object(k.a)() && !p) {
            self.Module.instantiateWasm = function (m, u) {
              return Object(b.a)(
                "".concat(h, "Wasm.wasm"),
                m,
                l["Wasm.wasm"],
          ...
          if (self.runtimeInitialized) {
            ...
            if (u) {
              ...
              if (!l || p < u.length)
                l && Module._free(l),
                  (p = u.length),
                  (l = Module._malloc(u.length));
              Module.HEAP8.set(u, l);
            }
            self.workerCallbackId = q.data.callbackId;
            try {
              u ? m(l, u.length) : m(0, 0);
            } catch (n) {
              postMessage({
