    ...
    (n = [
      ...
      function (t, e) {
        ...
        (p.Convert =
          ...
          (p.Convert.OfficeToPDFOptions.StructureTagLevel = {
            e_default: 0,
            e_none: 1,
          }),
          (p.Convert.OfficeToPDFOptions.DisplayComments = {
            e_off: 0,
            e_annotations: 1,
          }),
          ...
          (p.Convert.OfficeToPDFOptions.prototype.getDisplayComments =
            function () {
              return "DisplayComments" in this.mImpl
                ? this.mImpl.DisplayComments
                : 0;
            }),
          (p.Convert.OfficeToPDFOptions.prototype.setDisplayComments =
            function (t) {
              return (
                this.mHelpers.putNumber(this.mImpl, "DisplayComments", t), this
              );
            }),
        ...
        (p.SecurityHandler.prototype.changeUserPasswordBuffer = function (t) {
          ...
          var e = y(t, !1);
          return p.sendWithPromise("SecurityHandler.changeUserPasswordBuffer", {
            sh: this.id,
            password_buf: e,
          });
        }),
