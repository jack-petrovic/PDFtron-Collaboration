...
WebViewerConstructor(
  ...
  // eslint-disable-next-line no-undef
  const iframeDocument = WebViewerConstructor === WebViewer.WebComponent ? document.getElementsByTagName('apryse-webviewer')[0].shadowRoot : instance.UI.iframeWindow.document;
